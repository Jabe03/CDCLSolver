...
public class main{
    public static void main(String[] args) {
        ...
        ClauseSet clauseset = CNFReader.readFile("propagate_test", true);
        ...
        while (propagateQueue.isEmpty() == false) {
            ...
            for (int i = 0; i < propClauses.size(); i++) {
                ...
                while ((correctLits.contains(currentClause[nextWatched]) || correctLits.contains(-currentClause[nextWatched])) && nextWatched < currentClause.length - 2) {
                    nextWatched = nextWatched + 1;
                    System.out.println(clauseIndex);
                    System.out.println(currentClause[nextWatched] + " " + currentClause.length + " " + nextWatched);
                }
